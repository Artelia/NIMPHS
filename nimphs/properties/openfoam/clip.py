...
from nimphs.properties.utils.properties import scalars
from nimphs.properties.utils.properties import update_clip_value


class NIMPHS_OpenfoamClipScalarProperty(PropertyGroup):
...
class NIMPHS_OpenfoamClipProperty(PropertyGroup):
    """Clip settings."""
    ...
    #: NIMPHS_OpenfoamClipScalarProperty: Clip scalar settings
    scalar: PointerProperty(type=NIMPHS_OpenfoamClipScalarProperty)
