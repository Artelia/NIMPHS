...
class TelemacVertexColorUtils(VertexColorUtils):
    ...
    @classmethod
    def prepare(cls, bmesh: Mesh, point_data: Union[NIMPHS_PointDataSettings, str], file_data: TelemacFileData,
    ...
    @classmethod
    def prepare_LI(cls, bmesh: Mesh, point_data: NIMPHS_PointDataSettings, file_data: TelemacFileData,
...
class OpenfoamVertexColorUtils(VertexColorUtils):
    ...
    @classmethod
    def prepare(cls, bmesh: Mesh, point_data: Union[NIMPHS_PointDataSettings, str],
                file_data: OpenfoamFileData) -> VertexColorInformation:
        """
        Prepare point data to generate vertex colors.
