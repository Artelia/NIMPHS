...
from nimphs.operators.shared.utils import update_start
...
class NIMPHS_CreateSequence(Operator):
    ...
    def poll(self, context: Context) -> bool:
        ...
        return obj.nimphs.module in ['OpenFOAM', 'TELEMAC'] and not context.scene.nimphs.m_op_running
    ...
    def draw(self, context: Context) -> None:
        ...
        if self.point_data.import_data:
            ...
            if context.scene.nimphs.op_vars.length() < self.limit_add_point_data:
                row = box.row()
